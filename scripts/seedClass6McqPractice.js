...
// ───────────────────────────────────────────────────────────────────────────
// Seed Class 6 "MCQ Practice" content (Practice tab → MCQ Practice) into the
// DB-backed MCQ model:  subjects → chapters(class_level=6) → subtopics → mcq_questions.
//
...
//
//   EXAMIN8_COOKIE=… EXAMIN8_CSRF=… node scripts/seedClass6McqPractice.js            # FETCH (+checkpoint), dry
//   EXAMIN8_COOKIE=… EXAMIN8_CSRF=… ONLY=science node scripts/seedClass6McqPractice.js  # one subject
//   node scripts/seedClass6McqPractice.js --seed --live                              # SEED from checkpoints
// ───────────────────────────────────────────────────────────────────────────
...
const SUBJECTS = [
  ...
  // No practice bank; source MCQ Practice from important-questions (iq:true).
  { name: 'सामाजिक विज्ञान',                    slug: 'samajik-vigyan',                   res: '10916', iq: true },
]
