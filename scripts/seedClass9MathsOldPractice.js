...
// Class 9 "Old - Maths" (examin8 resource 1234). `res` is the practice subject id
// (also the examin8 resource/category id) used by /practice/topics-q-attempt-data/:res/.
const SUBJECTS = [
