...
// ───────────────────────────────────────────────────────────────────────────
// Seed Class 6 "Online Tests" (timed MCQ testpapers) into ot_tests /
// ot_questions. examin8 structure:
...
//
//   EXAMIN8_COOKIE=… EXAMIN8_CSRF=… node scripts/seedClass6OnlineTests.js            # FETCH (dry)
//   EXAMIN8_COOKIE=… EXAMIN8_CSRF=… ONLY=science node scripts/seedClass6OnlineTests.js
//   node scripts/seedClass6OnlineTests.js --seed --live                              # SEED from checkpoints
// ───────────────────────────────────────────────────────────────────────────
...
// Class 6 subjects that expose Online Tests. `res` = examin8 content/category (subject) id.
const SUBJECTS = [
