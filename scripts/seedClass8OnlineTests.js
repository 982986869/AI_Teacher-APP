...
// ───────────────────────────────────────────────────────────────────────────
// Seed Class 8 "Online Tests" (timed MCQ testpapers) into online_tests /
...
//
//   EXAMIN8_COOKIE=… EXAMIN8_CSRF=… node scripts/seedClass8OnlineTests.js            # FETCH (dry)
//   EXAMIN8_COOKIE=… EXAMIN8_CSRF=… ONLY=science node scripts/seedClass8OnlineTests.js
//   node scripts/seedClass8OnlineTests.js --seed --live                              # SEED from checkpoints
// ───────────────────────────────────────────────────────────────────────────
...
const CLASS_LEVEL = 8
const DELAY = 130
const CACHE = path.join(ROOT, 'src', 'data', 'class8OnlineTests')
...
async function seed(docs) {
  ...
  try {
    ...
    for (const doc of docs) {
      ...
      console.log(`  ✓ ${doc.name}: ${doc.chapters.length} chapters, ${nTests} tests, ${nQ} questions (class_level=8)`)
    }
