...
// Self-contained "You're all set!" screen (no external braingym import, so it
// can't fail to render). `onFinish` is provided by AppNavigator; calling it
// advances to the Onboarding screen.
const ITEMS = [
